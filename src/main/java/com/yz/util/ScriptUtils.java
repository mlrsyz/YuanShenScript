...
//            }
    ...
    public static void main(String[] args) {
        ...
        String dyCookie = "acf_did=0aeea4178642c76031cb792200051601; dy_did=0aeea4178642c76031cb792200051601; smidV2=20220827131020bb46ebadce070958fd2fc3f106ba7bfe006ea6ecd50bf3ae0; Hm_lvt_e99aee90ec1b2106afe7ec3b199020a7=1667630238,1667632935,1667662832,1667664172; PHPSESSID=dsmcsn787vqofnbvpp0solq4l4; acf_ccn=042598bcec048f96b0757c6206363e48; PAY_DOT_SOURCE_FROM=; acf_auth=3323efIxhGlci0bdxUP7uuRsczidIK3rtzwNujr/rU10Bd74n/cf0D8KaGDtmiJq8hCBuvuFSERxq0D1quTZfHkQ9PF6GuemS4DtzPnMbWFLxuu5G2IR; dy_auth=ebe7LjjU7OlvBY7FQZCvNINCKlXPWJiWe9EqjDeYXTsbo61ufa26WJKn4wwY1K5P7CIVFxVm6E9sLl+bgdO3GkoWbzkxoCUM6q4r2XoY7lVtWvAeM4l1; wan_auth37wan=75679ad7a537WzMaU/O8nbIDHKo8xFv/qAb9oNSpYgkS8kJGjkgNInro2vybEh6KBtyQBmylt5lIQh0wXhTDtNGTRAtAx4aGIr4oFd5j+hR8jFBNrg; acf_uid=94497424; acf_username=94497424; acf_nickname=梦離若殇; acf_own_room=1; acf_groupid=1; acf_phonestatus=1; acf_avatar=https://apic.douyucdn.cn/upload/avanew/face/201612/14/23/1a93a78bc843685d713602689ed7fbe9_; acf_ct=0; acf_ltkid=81259585; acf_biz=1; acf_stk=b5c87e5abfdc5533; Hm_lpvt_e99aee90ec1b2106afe7ec3b199020a7=1667666300";
        String biCookie = "buvid3=E9BFF8A5-FBBF-DB65-0D69-7ABB2A609A9481147infoc; _uuid=C8FE4C25-A756-5814-7E44-1A1A1247FA6280871infoc; buvid4=B26BD057-DE29-DC86-D59F-10C5D0C8EAC482237-022031619-kji2bknSwKco8f52F6rjzQu1hstbLjNPkiJRLc50Ghd04Ex55Uu24Q==; rpdid=0zbfAHGGS5|SKQVpjnQ|3XA|3w1Nusda; LIVE_BUVID=AUTO5716475960417726; nostalgia_conf=-1; CURRENT_BLACKGAP=0; buvid_fp_plain=undefined; i-wanna-go-back=-1; hit-dyn-v2=1; blackside_state=0; is-2022-channel=1; b_nut=100; fingerprint3=69925bb39c9877b53c6667b700549ddb; CURRENT_QUALITY=80; DedeUserID=102462368; DedeUserID__ckMd5=76421ba71f67f422; b_ut=5; dy_spec_agreed=1; fingerprint=06815c97c25c72f4a04ff58786b8d5ef; SESSDATA=8c627420,1683214942,e100b*b2; bili_jct=04331b2ad350ddab1d7dd3d997475477; sid=8k36vfd3; hit-new-style-dyn=0; bp_video_offset_102462368=725007882943201299; PVID=3; CURRENT_FNVAL=4048; b_lsid=34EF958A_1844D7AA22E; buvid_fp=06815c97c25c72f4a04ff58786b8d5ef; innersign=1";
        LocalDateTime dateTime = null;
        dateTime = LocalDateTime.of(2022, 11, 7, 0, 0, 1);
        scripts.add(execLocalScript(biCookie, ActivityType.bibi_5_660, dateTime));
//        for (int i = 0; i < 3; i++) {
//            scripts.add(execLocalScript(dyCookie, ActivityType.douYu_5_660, dateTime));
//        }
        while (true) {
